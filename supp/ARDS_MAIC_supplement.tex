...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, sharp corners, boxrule=0pt, frame hidden, interior hidden, enhanced]}{\end{tcolorbox}}\fi
...
\textbf{Supplementary Table 1. Details of included studies.}

\textbf{Supplementary Table 2. Gene list information content and
contribution.}
...
\textbf{Supplementary Table 3. ARDS MAIC prioritised genes found in
...
\textbf{Supplementary Table 4. ARDS susceptibility gene list information
...
\textbf{Supplementary Table 5. ARDS survival/severity gene list
