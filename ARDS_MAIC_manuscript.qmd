...
Despite the majority of gene lists being derived from blood samples, most genes included in the meta-analysis were identified in airways samples (n=5,847, 82.5%) (Fig. S3). This was true for the prioritised set of genes, however, here most were also identified in blood (n=818, 62.6%) (Fig. S3). For the genes uniquely found in lists derived from blood samples (n=1,238), almost three-quarters are known to be expressed in the lung (HPA scRNA-seq data, ≥ 5 normalised transcripts per million (nTPM)), with a quarter highly-expressed (≥ 100 nTPM) (Fig. S3).
